"""Compare connection types: Residual vs HC vs mHC.

    python scripts/compare_connection.py --tokenizer tokenizer.json
"""
...
VARIANTS = [
    ...
    ("HC (n=2)", {"connection": "hc", "connection_expansion": 2}),
    ("mHC (n=2)", {"connection": "mhc", "connection_expansion": 2}),
]
