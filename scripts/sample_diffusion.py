...
model = MODELS[args.model].load(args.checkpoint, device=device)
model.eval()
...
samples = SAMPLERS[args.model](model, fwd, batch_size=args.num_samples, seq_len=args.seq_len, **sample_kwargs)
