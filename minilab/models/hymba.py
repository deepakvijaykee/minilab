...
class HymbaConfig(BaseConfig):
    ...
    def _validate_transformer_branch_fields(self):
        ...
        require(self.attention not in {"gemma3", "gemma4"}, (
            "Gemma local-global attention schedules are implemented by GPT, not HymbaLM"
        ))
        ...
        if self.attention == "qwen3_next":
            require(self.position == "yarn_rope", "Qwen3-Next-style HymbaLM requires position='yarn_rope'")
