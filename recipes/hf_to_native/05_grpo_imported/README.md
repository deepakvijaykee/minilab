...
group-relative advantage density, while more generations without more
steps multiplies the per-step cost without giving the optimizer
enough updates to use the richer gradient. Both knobs should move
together when looking for an actual RLVR effect on an imported
baseline.
